...
public class AlertLogDetailPresenter extends BasePresenter<WorkOrderDetailContract.View> implements WorkOrderDetailContract.Presenter {

    public AlertLogDetailPresenter(WorkOrderDetailContract.View mView) {
        super(mView);
    }
